...
::: {.notes}
- First, syntax for studies without replicate weights
...
::: {.notes}
- Use the survey design object not the raw data
- As with {dplyr}, need to call the `survey_mean()` function *within* the `summarize()` function
